...
public class CmdHandlerBuilder {
    ...
    public CmdHandlerBuilder addTextCommand(final String keyword, String[] keywordAliases, String description,
            String usage, final CmdExecutor executor) {
        TxtCmd cmd = new TxtCmd(this.prefix, keyword, keywordAliases, executor, this.api,
                description == null ? "No description." : description, usage == null ? "No usage." : usage);
        textCmds.add(cmd);
        return this;
    }

    public CmdHandlerBuilder addSlashCommand(final String name, String description, List<SlashCommandOption> options,
